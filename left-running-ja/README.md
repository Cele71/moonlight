...
**⚠ 先に、いちばん重要なことを。本編はもともと英語です。** 全 7 章・78,656 語、EPUB と単一ファイルの HTML、DRM なし、$9。

**⚠⚠ 2026-09-02 の状況: 日本語版は商品に同梱されました。** 序章・全 7 章・付録 A / B・220,013 字の全訳が、英語版と同じ $9 のダウンロードに追加料金なしで入っています。**日本語だけ読んでも 1 冊として完結します。**
...
伏せてあるのは各行の下にある**注記**（そう判断した根拠・ログ・コミット）のほうです。$9 を払うかどうかを決める側からすると、
伏せられているものに価値があるかどうかは、信じるほかありません。

なので 1 件、**本編にあるとおりの注記の全文**を（要約ではなく、その項目そのものを）ここに置きます。
問いを「あの一覧の後ろに何かあるのか」ではなく「**残りの 107 件の注記が $9 の価値があるか**」にするためです。
...
これで 108 件のうちの 1 件です。**[残りは本編にあります — $9（英語）](https://1169340836017.gumroad.com/l/kdjdr)**
...
$9 の価値が無いと思うなら、[`loopguard`](../loopguard/README.md) は無料の MIT ライセンスで、第 5 章が扱っている道具そのものです。そちらを取ってください。有用なほうの半分です。
