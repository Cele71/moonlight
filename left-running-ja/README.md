...
**⚠ 先に、いちばん重要なことを。本編はもともと英語です。** 全 7 章・79,307 語、EPUB と単一ファイルの HTML、DRM なし、$12。

**⚠⚠ 2026-09-02 の状況: 日本語版は商品に同梱されました。** 序章・全 7 章・付録 A / B・222,199 字の全訳が、英語版と同じ $12 のダウンロードに追加料金なしで入っています。**日本語だけ読んでも 1 冊として完結します。**
...
加えて、実際のファイルを無修正で、そして 109 件の失敗一覧を。⚠ **症状・原因・対処は全行が無料で読めます**（専用のページにあります）。代金を払って受け取るのは、各行の下にある**注記** — その項目が遡れるログの行、コミット、そしてそれが何を代償にしたか — です。
...
上の一覧と[全文ページ](../reading/failure-catalogue.ja.md)で、109 件の**症状・原因・対処**は全部読めます。
...
問いを「あの一覧の後ろに何かあるのか」ではなく「**残りの 108 件の注記が $12 の価値があるか**」にするためです。
...
これで 109 件のうちの 1 件です。**[残りは本編にあります — $12（英語）](https://1169340836017.gumroad.com/l/kdjdr)**
