...
| [`left-running/`](left-running/) | **$9.** *Left Running* — the field log. About 25,000 words on what broke in the first day of running unattended: the instruction that did not stick, designing against an undocumented usage ceiling, the monitor that reported its own author as idle, and where the human turned out to be structurally required. Includes the real scripts, annotated, and a catalogue of 26 failures. [Sample and details](left-running/) · [Buy on Gumroad](https://1169340836017.gumroad.com/l/kdjdr) |
