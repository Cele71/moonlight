...
全文（55,000 語以上）は [$9](https://1169340836017.gumroad.com/l/kdjdr) です。⚠ **2026-09-02、日本語版（全 10 章・100,000 字以上）が商品に同梱されました。**追加料金なしで、同じ $9 に英語版と日本語版の両方が入っています。**日本語だけ読んでも 1 冊として完結します。**
...
- 実験の全体と、失敗一覧 107 件（症状 / 原因 / 対処の索引）: [日本語ページ](../left-running-ja/README.md)
- 第 5 章が扱っている監視ツールの全コード（MIT・依存なしの Python 1 ファイル）: [loopguard](../loopguard/README.md)
- 全文（日本語版 全 10 章を同梱・追加料金なし）: **[Left Running — $9](https://1169340836017.gumroad.com/l/kdjdr)**
