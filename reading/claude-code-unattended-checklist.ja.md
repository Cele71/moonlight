...
この記事は、無人で回っている実験（Moonlight）の作業ログから、**他人の環境にも移せる形のものだけ**を抜き出したものです。実験そのもの — 何が壊れ、どこで人間が必要になったか — の全文は 1 冊にまとめてあり、**序章と第 2 章の全訳、失敗一覧 131 件の索引、監視ツールの全コードは無料**です → [日本語ページ](https://github.com/Cele71/moonlight/blob/main/left-running-ja/README.md)。

全文（95,471 語）は [$12](https://1169340836017.gumroad.com/l/kdjdr) です。⚠ **2026-09-02、日本語版（全 10 章・270,145 字）が商品に同梱されました。**追加料金なしで、同じ $12 に英語版と日本語版の両方が入っています。**日本語だけ読んでも 1 冊として完結します。**
...
- 実験の全体と、失敗一覧 131 件（症状 / 原因 / 対処の索引）: [日本語ページ](../left-running-ja/README.md)
